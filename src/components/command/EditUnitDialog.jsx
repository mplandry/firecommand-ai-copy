...
const assignments = [
  ...
  { value: 'division_a', label: 'Division Alpha' },
  { value: 'division_b', label: 'Division Bravo' },
  { value: 'division_c', label: 'Division Charlie' },
  { value: 'division_d', label: 'Division Delta' },
  { value: 'roof', label: 'Division Roof' },
